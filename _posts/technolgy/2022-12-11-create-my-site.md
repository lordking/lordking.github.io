...
![create_site_in_github](/assets/images/technology/create_site_in_github.png)
...
![add_dev_container_configuration_files](/assets/images/technology/add_dev_container_configuration_files.png)
...
2. 打开`Settings`
3. 点击`Pages`，输入如下类型配置
![github_settings_pages](/assets/images/technology/github_settings_pages.png)
